...
[![version](https://img.shields.io/badge/version-1.0.2-555555?style=flat-square)](https://www.npmjs.com/package/smart-msg)
...
|  단계  | 항목                  | 선택지                                                |
| :--: | ------------------- | -------------------------------------------------- |
|  1   | AI provider         | **Google Gemini (무료, 기본)** / OpenAI / Anthropic Claude |
...
기존에 설치된 `smart-msg` 를 최신 버전으로 갱신합니다.
